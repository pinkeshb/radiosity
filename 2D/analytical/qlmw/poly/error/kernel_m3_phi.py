    ...
    for i in range(0,n*3):
        for j in range(0,n*3):
            ...
            if i%3==2 and j%3==2:
                ...
                # y=[dia_trans(z,a,(i/3)/float(n),phi_0_m3) for z in m]
                # pyplot.plot(m,y)
                # # print y ,"y"
                # pyplot.show()
...
# j=1
# f1 = lambda s, t: s-t
# f=lambda s,t: f1(s,t)*dia_trans(s,a,(i/2)/float(n),phi_0_m3)*dia_trans(t,a,(j/2)/float(n),phi_1_m3)
# n=4
...
# y=[dia_trans(z,a,(i/2)/float(n),phi_0_m3) for z in m]
# pyplot.plot(m,y)
# print y ,"y"
# pyplot.show()
if __name__ == "__main__":
    K,K_error= project_kernel_m3_phi(4)
    print "k",K
