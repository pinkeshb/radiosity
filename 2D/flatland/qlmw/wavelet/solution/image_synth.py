...
def get_pix(x,B_norm,n):
    ...
    # print i,"i"
    # print "3*i+1", 3*i+1
    b_error=lambda s:B_norm[3*i]*dia_trans(s, a, i  / float(n), phi_0_m3)+\
...
#     a=1.0/n
#     for i in range(n):
#         B1_proj[2*i]=dia_trans(0,a,0,phi_1_m3)*B1[2*i]
#         B2_proj[2*i]=dia_trans(0,a,0,phi_1_m3)*B2[2*i]
#         B1_proj[2*i+1]=-dia_trans(0,a,0,phi_2_m3)*B1[2*i+1]
#         B2_proj[2*i+1]=-dia_trans(0,a,0,phi_2_m3)*B2[2*i+1]
