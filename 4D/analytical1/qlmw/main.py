...
def main_fn(n, thres,dist):
    # fname = str(n) + 'm3_scale' + ".txt"
    # fo = open(fname, "w")

    K = project_kernel_m3_phi(n)
    # K=readit(n,dist)
    # print "K",K
    E1 = [[1.0/n for x in range(3*n)] for x in range(3*n)] 
    for i in range(3*n):
        for j in range(3*n):
            if i%3!=0 or j%3!=0:
                E1[i][j]=0
    ...
    # print E1
    # E2 = [[0 for x in range(3*n)] for x in range(3*n)] 

    B1 = [[0 for x in range(3*n)] for x in range(3*n)] 
    # B2 = [[0 for x in range(3*n)] for x in range(3*n)] 
    B1_pre = [[1 for x in range(3*n)] for x in range(3*n)] 
    # B2_pre = [[1 for x in range(3*n)] for x in range(3*n)] 
